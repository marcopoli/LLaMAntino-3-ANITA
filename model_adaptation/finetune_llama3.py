...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(
        ...
        warmup_steps = 100,
        learning_rate = 8e-6, #smaller steps for 2e-5 for unsupervised ITA - standard 2e-4 for finetune
        fp16 = not torch.cuda.is_bf16_supported(),
        bf16 = torch.cuda.is_bf16_supported(),
        logging_steps = 1,
        optim = "paged_adamw_32bit",#"adamw_torch", #"paged_adamw_8bit",#paged_adamw_32bit
        weight_decay = 0.01,
